document.addEventListener('DOMContentLoaded', () => {
    ...
    const selectModel = 'gpt-3.5-turbo';
    ...
    createChatButton.addEventListener('click', async () => {
        try {
            ...
            if (response.ok) {
                ...
                currentChat.style.backgroundColor = 'rgb(0,0,0,0.1)';
    ...
    async function sendMessage(currentChatId) {
        try {
            ...
            const response = await fetch(`${BASE_URL}/chats/${chatId}/${selectModel}/send_question`, {
